...
void printWithColour(const font_data &ft_font, float x, float y, GLfloat colour[], const char *fmt, ...);
//a messy function thrown together that will hopefully get me the length of the string in pixels
//actually invisibly draws the string. not efficient but meh!
float getStringWidth(const font_data &ft_font, float x, float y, const char *fmt, ...);
